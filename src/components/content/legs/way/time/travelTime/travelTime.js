...
class TravelTime extends React.Component {
    render(props) {
        ...
        let departureTime = Date.parse(this.props.data.flight.legs[1].segments[0].departureDate)/1000;
        let arrivalTime = Date.parse(this.props.data.flight.legs[1].segments[num].arrivalDate)/1000;
